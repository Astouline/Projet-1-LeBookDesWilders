              ...
              <div class="col-sm-6 offset-sm-1 col-12 my-auto">
                ...
                <div class="row d-flex justify-content-center pl-3">
                  ...
                  <figure class="col-4 col-lg-3 text-center w-50">
                    ...
                    }" title="Lien linkedin" target="_blank"><span data-balloon="size: 2x"
                        data-balloon-pos="up" class="iconmodal"><svg aria-hidden="true" data-prefix="fab" data-icon="linkedin"
                  ...
                  <figure class="col-4 col-lg-3 text-center">
                    ...
                    }" title="Lien Github" target="_blank"><span data-balloon="size: 2x"
                        data-balloon-pos="up" class="iconmodal"><svg aria-hidden="true" data-prefix="fab" data-icon="github"
                  ...
                  <figure class="col-4 col-lg-3  text-center">
                    ...
                    <a href="#" title="Adresse Mail" class="copy"><span data-balloon="size: 2x"
